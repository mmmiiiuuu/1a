var src = $('#grid2');
var wrap = $('<div id="grid-overlay2"></div>');
var gsize = 7;
var grid = 1802;
...
var tbl2 = $('<table onmousedown2="return false;"></table>');
...
var setBitString2 = function(string) {
    if (string.length > grid2Area) bitError.text("Thats too big!"); else bitError.text("");
    bitString = string.replace(/0+$/g, "");
    $("#bitArea").val(bitString);
}

var setDecString2 = function(bigNum) {
    decimal = bigNum;
...
$('#grid-overlay2 td').hover(function () {
    $(this).toggleClass('hover');
});

$('#grid-overlay2 td').mouseup(function () {
...
$('#grid-overlay2 td').mousedown(function () {
...
function setPresetUrl() {
    ...
    if (base62String !== '0.000000000012wzo68sAM') {
