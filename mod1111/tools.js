...
///////////////////////////////////////////////////////////////	
	function canvasApp()
	{
		...
		if(resizeCanvas2)
		{
			...
			{
				canvas1.width = Math.ceil(canvas1.width*pixelsPerUnit/8);
				canvas1.height = Math.ceil(canvas1.height*pixelsPerUnit/8);
			}
		}
		canvas2 = document.getElementById("canvas2");
		ctx=canvas1.getContext("2d");
		
		canvas1.addEventListener('keydown',  function (e) {keyboardHndlr(e);}, true);
...
//		e.preventDefault();
	...
	{
		var currX = e.pageX - canvas1.offsetLeft;
		var currY = e.pageY - canvas1.offsetTop;
...
//			str += '\n';
	...
	{		
		...
		ctx.clearRect(0, 0, canvas1.width, ya);
		ctx.clearRect(0, yb, canvas1.width, canvas1.height-yb);
		ctx.clearRect(0, 0, xa, canvas1.height);
		ctx.clearRect(xb, 0, canvas1.width-xb, canvas1.height);
		
		ctx.lineWidth = 1;
		ctx.strokeStyle = 0,0,0,0;
		ctx.strokeRect(xa, ya, 106*pixelsPerUnit, 17*pixelsPerUnit);
		ctx.strokeStyle = 0,0,0,0;
		ctx.strokeRect(xa, ya, 106*pixelsPerUnit, 17*pixelsPerUnit);
		
		ctx.strokeStyle = 0,0,0,0;
		ctx.fillStyle = 0,0,0,0;
...
//		var canvas2 = document.getElementById("canvas2");
		...
		ctx2.fillStyle = 0,0,0,0;
		ctx2.clearRect(0, 0, canvas1.width, canvas2.height);
		ctx2.fillRect(0, 0, canvas2.width, canvas2.height);
		
		if(incForm)
		{
			ctx2.drawImage(tupFormImg, 0, 0);
			ctx2.fillRect(tupFormImg.width, 0, 10, 32);
		}
		...
		document.getElementById('link2img').href = canvas.toDataURL();
...
//		return -1 * tmp;
	...
	function showSteps()
	{
		...
		var stepsHTML = '\n<br />\n<strong>Podzielona przez 17:</strong><br />\n<pre>\n' + num2o + '\n</pre><br /><br />\n<strong>DwÃ³jkowo:</strong><br />\n<pre>\n' + binO 
					+ '\n</pre>\n<br /><br />\n<strong>DwÃ³jkowo (z podziaÅ‚em na 106 kolumn z 17-bitowymi liczbami):</strong><br />\n<pre>\n' + bin2o + '\n</pre>\n\n<br /><br />\n<strong>DwÃ³jkowo (z podziaÅ‚em na 106 kolumn z 17-bitowymi liczbami - odwrÃ³cone):</strong><br />\n<pre>\n' + bin3o + '\n</pre>\n';
